    ...
    return (
        ...
        <div className='boxes'>
            ...
            <div className="google-drive-folder">
                ...
                <iframe src={`https://googledriveembedder.collegefam.com/?key=AIzaSyAvuXPOZeOq6MRL-zBqc_15WWoMPsesA9s&folderid=13z3SH4XIhV5K6F6Sv8n-rJ-ebaz89tBB`} width="100%" style={{ height: "60vh" }}></iframe>
            </div>
        </div>
        </div>
    );
